...
For my Chatbot, I created the Tchaikovsky Chatbot which has the main function of answering questions regarding the life and achievements of composer Pydor Tchaikovsky. As far as strengths, my chatbot did a good job of recalling specific details about his life and works in a factual sense. Answers to questions were informative and to the point without any excessive or pointless information. One of the most notable weaknesses of my chatbot was likely regarding asking more "feeling" based questions regarding Tchaikovsky's music, such as the emotional effect of certain musical pieces on individuals. Additionally, the general tone of the chatbot could come across as awkward or cold which could make it unappealing to the user.
...
Using BoodleBox, I uploaded my resume and asked what field/job I'd be most suitable for based on the most current version of it. According to Perplexity, my resume is best suited for a technical writer or a virtual paralegal. These are actually both fields I'd like to get into following graduation, so I asked Perplexity to refine my resume to better suit the technical writing field specifically. According to the chatbot, I should focus more on highlighting my communication skills and relevant experience. This means adding relevant work experience with metrics and listing technical skills with course/portfolio work that is relevant to the technical writing field. 

Based off this response, I learned I should create a more specialized version of my resume that focuses on specific skills versus a wide variety of skills. This means, reducing "information clutter" on my resume and removing skills or experiences I may have that aren't entirely relevant to the field I'm trying to get into. Likewise, I should also be presenting broader skills (such as time management or multi-tasking) in a light that demonstrates how they can be best applied/are relevant to the technical writing field. In short, this prompt showed that I should focus more on presenting my most applicable skills for a job field versus just listing *all* of the skills and experience I have.
